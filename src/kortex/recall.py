...
def _load_graph_and_index(paths: KortexPaths):
...
def search_notes(paths: KortexPaths, query: str, limit: int = 5) -> list[dict]:
...
def read_note_text(paths: KortexPaths, title: str) -> str | None:

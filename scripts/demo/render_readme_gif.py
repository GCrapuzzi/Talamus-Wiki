...
SCENES = (
    Scene(
        ...
        (
            ...
            TerminalLine("  Successfully installed talamus 1.0.1", GREEN),
            TerminalLine(""),
            TerminalLine("$ talamus setup", CYAN),
            TerminalLine("  engine: codex-cli (found)", MUTED),
            TerminalLine("  MCP connected · session capture enabled", GREEN),
    ...
    Scene(
        ...
        (
            ...
            TerminalLine(""),
            TerminalLine("Your agent remembered. Locally. €0.", VIOLET),
